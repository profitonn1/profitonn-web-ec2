...
export default function BasicChallengeButton({ onClick, onItemClick }) {
  ...
  if (loading) return <p className="text-center w-screen">Loading...</p>
  ...
  return (
    <div className="flex justify-center">
      <div
        onClick={onClick}
        className="border-2 w-[80vw] cursor-pointer max-w-full bg-indigo-700 items-center text-sm lg:text-lg border-gray-300 mt-1"
      >
        {data.length > 0 ? (
          data
