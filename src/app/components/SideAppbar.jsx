  ...
  return (
    <div>
      ...
      <button
        ...
        className="fixed top-[18px] left-4 z-50 text-white text-3xl"
      >
        ☰
      </button>

      {/*  bg-[linear-gradient(90deg,_#00011a_40%,_transparent_100%)]         bg -gradient */}
      {/* Sidebar */}
      <aside
        id="default-sidebar"
        className={`fixed top-16 left-0 z-40 w-64 h-screen transition-transform bg-[#000000] ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`} // Add class to control opening and closing
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-6">
            <li>
              <button
                ...
                className="w-full border-white border-opacity-20 border-2 hover:scale-105 text-start flex items-center gap-x-3 p-3 rounded-lg hover:bg-blue-700 transition ease-in-out duration-300"
              >
                <svg
            ...
            <li>
              <button
                ...
                className="w-full border-white border-opacity-20 border-2 transition duration-300 ease-in-out transform hover:scale-105 text-start flex items-center gap-x-3 p-3 rounded-lg hover:bg-red-700"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
