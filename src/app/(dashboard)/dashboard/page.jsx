  ...
  return (
    <>
      ...
      <div className="bg-black">
        <div>
          <div className="text-center my-10 pt-10 lg:pt-16 lg:py-6">
            <h1 className="text-white text-3xl lg:text-8xl font-ubuntu lg:font-medium font-bold">
              Select a category
            </h1>
          </div>
          ...
          <div className="flex mb-12 flex-col items-center justify-center mt-4 lg:my-12">
            <h1 className="text-white text-xl font-semibold lg:text-6xl font-ubuntu lg:font-medium lg:mb-4">
              Not ready to risk real money?
            </h1>
            <p className="text-base lg:text-3xl mb-4 lg:mb-8 text-white opacity-60">
              Take a free demo trade with us
            </p>
            <button onClick={redirectToTerminal} className="bg-indigo-700 mb-8 hover:bg-indigo-500 transition
             duration-300 ease-in-out transform hover:scale-105
              rounded-lg tracking-wider font-medium lg:font-semibold text-white w-32 lg:w-44 p-1 lg:p-2 relative text-lg mx-5">
              Start
            </button>
            <div className="lg:w-[60vw] w-[94vw]">
              <Image src={terminal} alt="terminal image" className=" lg:h-full h-[250px]"/>
            </div>
          </div>
        </div>
        <Footer />
